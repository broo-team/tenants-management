...
import fileToDownload from '../../../assets/files/sample_employee_data.csv';
import {TbCopyCheck} from 'react-icons/tb';

const ImportEmployee = ({reload, openModalFun}) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const {
        data,
      } = await axios.post (`${BACKENDURL}/upload/csv/employee`, formData, {
